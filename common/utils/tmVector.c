...
int tmVectorCreate(tmVector CVECTOR_FAR * vectorhandle, const int elementsize, const int capacity) 
{
    size_t cap = capacity;
    
    if ((vectorhandle==NULL)) { return CVECTOR_BAD_ARGUMENT; }
    
    *vectorhandle = (tmVector)CVECTOR_MALLOC(sizeof(CVector));
...
int tmVectorAddElement(const tmVector vectorhandle, const void CVECTOR_FAR * element) {
...
int tmVectorGetElement(const tmVector vectorhandle, void CVECTOR_FAR * element, const int index) {
...
int tmVectorGetElementptr(const tmVector vectorhandle, void CVECTOR_FAR ** elementptr, const int index) {
...
int tmVectorSetElement(const tmVector vectorhandle, const void CVECTOR_FAR * element, const int index) {
...
int tmVectorRemoveElement(const tmVector vectorhandle, const int index) {
...
int tmVectorClear(const tmVector vectorhandle) {
...
int tmVectorFree(tmVector CVECTOR_FAR * vectorhandle) {
...
int tmVectorGetCapacity(const tmVector vectorhandle, int CVECTOR_FAR * capacity) {
...
int tmVectorGetSize(const tmVector vectorhandle, int CVECTOR_FAR * size) {
...
int tmVectorGetFlags(const tmVector vectorhandle, unsigned int CVECTOR_FAR * flags) {
...
int tmVectorSetCapacity(const tmVector vectorhandle, const int capacity) {
...
int tmVectorSetSize(const tmVector vectorhandle, const int size) {
...
int tmVectorSetFlags(const tmVector vectorhandle, const unsigned int flags) {
